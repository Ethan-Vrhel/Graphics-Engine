...
public class Input {
	 ...
	 * @return <code>true</code> if it is pressed and
	 ...
	 * 
	 * @param mouse The mouse button code.
	 * @return <code>true</code> if it is pressed and
	 * <code>false</code> otherwise.
	 */
	...
	/**
	 * Tests whether the mouse cursor is within
	 * the application window.
	 * 
	 * @return <code>true</code> if it is the window
